...
namespace One_Man_Army
{
    ...
    /// </summary>
    public class ExplosionParticle : IComparable
    {
        ...
        public void Initialize(Vector2 position, Vector2 velocity, Vector2 acceleration,
            float lifetime, float scale, float scaleAddend, float rotationSpeed, Texture2D tex)
        {
            ...
            this.Rotation = One_Man_Army_Game.RandomBetween(0, MathHelper.TwoPi);
        }
        ...
        {
            ExplosionParticle otherParticle = obj as ExplosionParticle;
            if (otherParticle != null)
                return this.TimeSinceStart.CompareTo(otherParticle.TimeSinceStart);
            else
                throw new ArgumentException("Object is not an ExplosionParticle");
        }
    }
}
