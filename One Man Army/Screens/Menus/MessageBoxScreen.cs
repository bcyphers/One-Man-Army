...
namespace One_Man_Army
{
    ...
    class MessageBoxScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            float scale = (float)Math.Pow((viewport.Width / 3) / textSize.X, 0.6);
            ...
            spriteBatch.Draw(gradientTexture, viewportRect, color);

            color = new Color(0, 0, 0, TransitionAlpha);
            // Draw the message box text.
            spriteBatch.DrawString(font, message, textPosition, color, 0, textOrigin, scale, SpriteEffects.None, 0);
